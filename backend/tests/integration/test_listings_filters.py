...
def test_integration_combined_filters(api_client=None):
    """Integration test exercising combined filters and pagination response."""
    # Create data
    ...
    # The listings endpoint is paginated and returns a dict with 'results'
    assert isinstance(data, dict), "Expected paginated response dict"
